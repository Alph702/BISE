...
def _fill_form_sync(data, Username: str, Password: str, submit: bool = False):
    gr = None
...
def fill_form_from_excel(data, Username, Password, submit: bool = False):
    process = multiprocessing.Process(
        target=_fill_form_sync, args=(data, Username, Password, submit)
    )
    process.start()
    process.join()
